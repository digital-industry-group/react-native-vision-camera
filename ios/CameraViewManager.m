...
RCT_EXTERN_METHOD(manuallyFocus: (nonnull NSNumber *)node lensPosition:(Float *)lensPosition resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject);
