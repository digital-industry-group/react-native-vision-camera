...
RCT_EXTERN_METHOD(manuallyFocus: (nonnull NSNumber *)node lensPosition:(nonnull NSNumber *)lensPosition resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject);
RCT_EXTERN_METHOD(getCurrentLensPosition: (nonnull NSNumber *)node resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject);
